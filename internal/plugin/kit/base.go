...
// EnhancedPluginBase extends plugin.PluginBase with plugin-scoped helper APIs.
//
// This is an opt-in layer: existing plugins can keep using plugin.PluginBase.
...
// InitEnhanced initializes the embedded plugin.PluginBase and constructs helpers.
